package a.a; class af { void a() { int a;
a=0;// .class final La/a/af;
a=0;// .super La/a/ge;
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;//     .locals 0
a=0;// 
a=0;//     invoke-direct {p0}, La/a/af;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,La/a/af;);
a=0;//     return-void
a=0;// .end method
...
a=0;//     iput-wide v0, p2, La/a/ae;->a:J
a=0;// 
a=0;//     invoke-virtual {p2}, La/a/ae;->a()V
a=0;// 
a=0;//     goto :goto_0
a=0;// 
a=0;//     :cond_0
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     iput-object v0, p2, La/a/ae;->b:Ljava/lang/String;
a=0;// 
a=0;//     goto :goto_0
a=0;// 
a=0;//     :cond_1
...
a=0;// 
a=0;//     #v0=(Integer);
a=0;//     invoke-static {v0}, La/a/ak;->a(I)La/a/ak;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     #v0=(Reference,La/a/ak;);
a=0;//     iput-object v0, p2, La/a/ae;->c:La/a/ak;
a=0;// 
a=0;//     goto :goto_0
a=0;// 
a=0;//     :cond_2
...
a=0;// 
a=0;//     iget-byte v0, p2, La/a/ae;->d:B
a=0;// 
a=0;//     #v0=(Byte);
a=0;//     const/4 v1, 0x0
a=0;// 
...
a=0;//     invoke-virtual {p2}, La/a/ae;->c()V
a=0;// 
a=0;//     return-void
a=0;// 
...
a=0;//     invoke-virtual {p2}, La/a/ae;->c()V
a=0;// 
a=0;//     invoke-static {}, La/a/ae;->d()La/a/ga;
a=0;// 
a=0;//     invoke-virtual {p1}, La/a/fu;->a()V
a=0;// 
a=0;//     invoke-static {}, La/a/ae;->e()La/a/fr;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     #v0=(Reference,La/a/fr;);
...
a=0;// 
a=0;//     iget-wide v0, p2, La/a/ae;->a:J
a=0;// 
a=0;//     #v0=(LongLo);v1=(LongHi);
a=0;//     invoke-virtual {p1, v0, v1}, La/a/fu;->a(J)V
a=0;// 
a=0;//     iget-object v0, p2, La/a/ae;->b:Ljava/lang/String;
a=0;// 
a=0;//     #v0=(Reference,Ljava/lang/String;);
a=0;//     if-eqz v0, :cond_0
a=0;// 
a=0;//     invoke-static {}, La/a/ae;->f()La/a/fr;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-virtual {p1, v0}, La/a/fu;->a(La/a/fr;)V
...
a=0;// 
a=0;//     :cond_0
a=0;//     iget-object v0, p2, La/a/ae;->c:La/a/ak;
a=0;// 
a=0;//     if-eqz v0, :cond_1
a=0;// 
a=0;//     invoke-virtual {p2}, La/a/ae;->b()Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
a=0;//     if-eqz v0, :cond_1
a=0;// 
a=0;//     invoke-static {}, La/a/ae;->g()La/a/fr;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     #v0=(Reference,La/a/fr;);
