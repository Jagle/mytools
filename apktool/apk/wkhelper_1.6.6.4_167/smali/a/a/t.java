package a.a; class t { void a() { int a;
a=0;// .class final La/a/t;
a=0;// .super La/a/ge;
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;//     .locals 0
a=0;// 
a=0;//     invoke-direct {p0}, La/a/t;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,La/a/t;);
a=0;//     return-void
a=0;// .end method
...
a=0;// 
a=0;//     #v0=(Integer);
a=0;//     iput v0, p2, La/a/s;->a:I
a=0;// 
a=0;//     invoke-virtual {p2}, La/a/s;->a()V
a=0;// 
a=0;//     goto :goto_0
a=0;// 
a=0;//     :cond_0
...
a=0;// 
a=0;//     #v0=(Integer);
a=0;//     iput v0, p2, La/a/s;->b:I
a=0;// 
a=0;//     invoke-virtual {p2}, La/a/s;->b()V
a=0;// 
a=0;//     goto :goto_0
a=0;// 
a=0;//     :cond_1
...
a=0;// 
a=0;//     #v0=(Integer);
a=0;//     iput v0, p2, La/a/s;->c:I
a=0;// 
a=0;//     invoke-virtual {p2}, La/a/s;->d()V
a=0;// 
a=0;//     goto :goto_0
a=0;// 
a=0;//     :cond_2
...
a=0;// 
a=0;//     iget-byte v0, p2, La/a/s;->d:B
a=0;// 
a=0;//     #v0=(Byte);
a=0;//     const/4 v1, 0x0
a=0;// 
...
a=0;//     invoke-static {}, La/a/s;->e()V
a=0;// 
a=0;//     invoke-static {}, La/a/s;->f()La/a/ga;
a=0;// 
a=0;//     invoke-virtual {p1}, La/a/fu;->a()V
a=0;// 
a=0;//     invoke-static {}, La/a/s;->g()La/a/fr;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     #v0=(Reference,La/a/fr;);
...
a=0;// 
a=0;//     iget v0, p2, La/a/s;->a:I
a=0;// 
a=0;//     #v0=(Integer);
a=0;//     invoke-virtual {p1, v0}, La/a/fu;->a(I)V
a=0;// 
a=0;//     invoke-static {}, La/a/s;->h()La/a/fr;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     #v0=(Reference,La/a/fr;);
a=0;//     invoke-virtual {p1, v0}, La/a/fu;->a(La/a/fr;)V
a=0;// 
a=0;//     iget v0, p2, La/a/s;->b:I
a=0;// 
a=0;//     #v0=(Integer);
a=0;//     invoke-virtual {p1, v0}, La/a/fu;->a(I)V
a=0;// 
a=0;//     invoke-virtual {p2}, La/a/s;->c()Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
...
a=0;// 
a=0;//     invoke-static {}, La/a/s;->i()La/a/fr;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     #v0=(Reference,La/a/fr;);
