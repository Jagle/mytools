package a.a; class cx { void a() { int a;
a=0;// .class public La/a/cx;
...
a=0;// 
a=0;// .field private static final h:Ljava/util/Map;
a=0;// 
a=0;// 
a=0;// # instance fields
...
a=0;//     sput-object v0, La/a/cx;->f:La/a/fr;
a=0;// 
a=0;//     new-instance v0, La/a/fr;
a=0;// 
a=0;//     #v0=(UninitRef,La/a/fr;);
...
a=0;// 
a=0;//     #v0=(Reference,La/a/fr;);
a=0;//     sput-object v0, La/a/cx;->g:La/a/fr;
a=0;// 
...
a=0;//     sput-object v0, La/a/cx;->h:Ljava/util/Map;
a=0;// 
a=0;//     const-class v1, La/a/ge;
a=0;// 
a=0;//     new-instance v2, La/a/cz;
a=0;// 
a=0;//     #v2=(UninitRef,La/a/cz;);
a=0;//     invoke-direct {v2, v3}, La/a/cz;-><init>(B)V
a=0;// 
a=0;//     #v2=(Reference,La/a/cz;);
a=0;//     invoke-interface {v0, v1, v2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
a=0;// 
a=0;//     sget-object v0, La/a/cx;->h:Ljava/util/Map;
a=0;// 
a=0;//     const-class v1, La/a/gf;
a=0;// 
a=0;//     new-instance v2, La/a/db;
a=0;// 
a=0;//     #v2=(UninitRef,La/a/db;);
a=0;//     invoke-direct {v2, v3}, La/a/db;-><init>(B)V
a=0;// 
a=0;//     #v2=(Reference,La/a/db;);
a=0;//     invoke-interface {v0, v1, v2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
a=0;// 
a=0;//     new-instance v0, Ljava/util/EnumMap;
a=0;// 
a=0;//     #v0=(UninitRef,Ljava/util/EnumMap;);
a=0;//     const-class v1, La/a/dc;
a=0;// 
...
a=0;// 
a=0;//     sput-object v0, La/a/cx;->d:Ljava/util/Map;
a=0;// 
a=0;//     const-class v0, La/a/cx;
a=0;// 
a=0;//     sget-object v1, La/a/cx;->d:Ljava/util/Map;
a=0;// 
...
a=0;// 
a=0;//     #p0=(Reference,La/a/cx;);
a=0;//     const/4 v0, 0x0
a=0;// 
a=0;//     #v0=(Null);
a=0;//     iput-byte v0, p0, La/a/cx;->c:B
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//     .locals 0
a=0;// 
a=0;//     invoke-direct {p0}, La/a/cx;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,La/a/cx;);
a=0;//     iput p1, p0, La/a/cx;->a:I
a=0;// 
a=0;//     invoke-virtual {p0}, La/a/cx;->a()V
a=0;// 
a=0;//     iput p2, p0, La/a/cx;->b:I
a=0;// 
a=0;//     invoke-virtual {p0}, La/a/cx;->b()V
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//     .locals 1
a=0;// 
a=0;//     sget-object v0, La/a/cx;->e:La/a/ga;
a=0;// 
a=0;//     #v0=(Reference,La/a/ga;);
...
a=0;//     .locals 1
a=0;// 
a=0;//     sget-object v0, La/a/cx;->f:La/a/fr;
a=0;// 
a=0;//     #v0=(Reference,La/a/fr;);
a=0;//     return-object v0
a=0;// .end method
...
a=0;//     .locals 1
a=0;// 
a=0;//     sget-object v0, La/a/cx;->g:La/a/fr;
a=0;// 
a=0;//     #v0=(Reference,La/a/fr;);
a=0;//     return-object v0
a=0;// .end method
...
a=0;//     .locals 1
a=0;// 
a=0;//     iget-byte v0, p0, La/a/cx;->c:B
a=0;// 
a=0;//     #v0=(Byte);
