package a.a; class fd { void a() { int a;
a=0;// .class final La/a/fd;
a=0;// .super La/a/ge;
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;//     .locals 0
a=0;// 
a=0;//     invoke-direct {p0}, La/a/fd;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,La/a/fd;);
a=0;//     return-void
a=0;// .end method
...
a=0;//     invoke-virtual {p2, p1, v0}, La/a/fc;->a(La/a/fu;La/a/fr;)Ljava/lang/Object;
a=0;// 
...
a=0;// 
a=0;//     iget-short v0, v0, La/a/fr;->c:S
a=0;// 
a=0;//     #v0=(Short);
...
a=0;//     :cond_1
a=0;//     #v1=(Uninit);
a=0;//     invoke-virtual {p2}, La/a/fc;->a()La/a/ga;
a=0;// 
a=0;//     invoke-virtual {p1}, La/a/fu;->a()V
a=0;// 
a=0;//     iget-object v0, p2, La/a/fc;->c:La/a/fa;
a=0;// 
a=0;//     invoke-virtual {p2, v0}, La/a/fc;->a(La/a/fa;)La/a/fr;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-virtual {p1, v0}, La/a/fu;->a(La/a/fr;)V
a=0;// 
a=0;//     invoke-virtual {p2, p1}, La/a/fc;->c(La/a/fu;)V
a=0;// 
