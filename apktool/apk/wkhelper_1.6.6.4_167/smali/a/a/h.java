package a.a; class h { void a() { int a;
a=0;// .class final La/a/h;
a=0;// .super La/a/ge;
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;//     .locals 0
a=0;// 
a=0;//     invoke-direct {p0}, La/a/h;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,La/a/h;);
a=0;//     return-void
a=0;// .end method
...
a=0;//     iput-wide v0, p2, La/a/g;->a:J
a=0;// 
a=0;//     invoke-virtual {p2}, La/a/g;->a()V
a=0;// 
a=0;//     goto :goto_0
a=0;// 
a=0;//     :cond_0
...
a=0;// 
a=0;//     iget-byte v0, p2, La/a/g;->b:B
a=0;// 
a=0;//     #v0=(Byte);
a=0;//     const/4 v1, 0x0
a=0;// 
...
a=0;//     invoke-static {}, La/a/g;->b()V
a=0;// 
a=0;//     invoke-static {}, La/a/g;->c()La/a/ga;
a=0;// 
a=0;//     invoke-virtual {p1}, La/a/fu;->a()V
a=0;// 
a=0;//     invoke-static {}, La/a/g;->d()La/a/fr;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     #v0=(Reference,La/a/fr;);
...
a=0;// 
a=0;//     iget-wide v0, p2, La/a/g;->a:J
a=0;// 
a=0;//     #v0=(LongLo);v1=(LongHi);
