package a.b; class b { void a() { int a;
a=0;// .class public final La/b/b;
...
a=0;// .end method
a=0;// 
a=0;// .method public static a(Ljava/lang/String;Ljava/lang/Exception;)V
a=0;//     .locals 2
a=0;// 
a=0;//     sget-boolean v0, La/b/b;->a:Z
a=0;// 
a=0;//     #v0=(Boolean);
...
a=0;//     invoke-virtual {p1}, Ljava/lang/Exception;->toString()Ljava/lang/String;
a=0;// 
