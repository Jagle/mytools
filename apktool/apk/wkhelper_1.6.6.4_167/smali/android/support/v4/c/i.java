package android.support.v4.c; class i { void a() { int a;
a=0;// .class final Landroid/support/v4/c/i;
...
a=0;//     .locals 0
a=0;// 
a=0;//     iput-object p1, p0, Landroid/support/v4/c/i;->a:Landroid/support/v4/c/f;
a=0;// 
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Landroid/support/v4/c/i;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;//     .locals 1
a=0;// 
a=0;//     iget-object v0, p0, Landroid/support/v4/c/i;->a:Landroid/support/v4/c/f;
a=0;// 
...
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/c/f;);
a=0;//     invoke-virtual {v0, p1}, Landroid/support/v4/c/f;->a(Ljava/lang/Object;)I
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Integer);
...
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/c/f;);
a=0;//     invoke-virtual {v0}, Landroid/support/v4/c/f;->b()Ljava/util/Map;
a=0;// 
...
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/c/f;);
a=0;//     invoke-virtual {v0, v2, v1}, Landroid/support/v4/c/f;->a(II)Ljava/lang/Object;
a=0;// 
a=0;//     move-result-object v0
a=0;// 
...
a=0;//     iget-object v1, p0, Landroid/support/v4/c/i;->a:Landroid/support/v4/c/f;
a=0;// 
...
a=0;//     invoke-interface {v0, v3}, Ljava/util/Map;->remove(Ljava/lang/Object;)Ljava/lang/Object;
a=0;// 
a=0;//     goto :goto_0
a=0;// 
a=0;//     :cond_0
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-static {v0, p1}, Landroid/support/v4/c/f;->a(Ljava/util/Map;Ljava/util/Collection;)Z
a=0;// 
a=0;//     move-result v0
a=0;// 
a=0;//     #v0=(Boolean);
