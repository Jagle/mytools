...
a=0;// 
a=0;// # instance fields
a=0;// .field a:[Landroid/support/v4/app/FragmentState;
a=0;// 
a=0;// .field b:[I
a=0;// 
a=0;// .field c:[Landroid/support/v4/app/BackStackState;
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;//     .locals 1
a=0;// 
a=0;//     new-instance v0, Landroid/support/v4/app/u;
a=0;// 
a=0;//     #v0=(UninitRef,Landroid/support/v4/app/u;);
a=0;//     invoke-direct {v0}, Landroid/support/v4/app/u;-><init>()V
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/app/u;);
...
a=0;// 
a=0;//     iput-object v0, p0, Landroid/support/v4/app/FragmentManagerState;->a:[Landroid/support/v4/app/FragmentState;
a=0;// 
a=0;//     invoke-virtual {p1}, Landroid/os/Parcel;->createIntArray()[I
a=0;// 
a=0;//     move-result-object v0
a=0;// 
a=0;//     iput-object v0, p0, Landroid/support/v4/app/FragmentManagerState;->b:[I
a=0;// 
...
a=0;// 
a=0;//     iput-object v0, p0, Landroid/support/v4/app/FragmentManagerState;->c:[Landroid/support/v4/app/BackStackState;
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//     .locals 1
a=0;// 
a=0;//     iget-object v0, p0, Landroid/support/v4/app/FragmentManagerState;->a:[Landroid/support/v4/app/FragmentState;
a=0;// 
...
a=0;// 
a=0;//     iget-object v0, p0, Landroid/support/v4/app/FragmentManagerState;->b:[I
a=0;// 
a=0;//     invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeIntArray([I)V
a=0;// 
a=0;//     iget-object v0, p0, Landroid/support/v4/app/FragmentManagerState;->c:[Landroid/support/v4/app/BackStackState;
a=0;// 
a=0;//     invoke-virtual {p1, v0, p2}, Landroid/os/Parcel;->writeTypedArray([Landroid/os/Parcelable;I)V
a=0;// 
a=0;//     return-void
