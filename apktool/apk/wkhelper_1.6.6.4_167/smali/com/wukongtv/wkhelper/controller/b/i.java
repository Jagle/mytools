package com.wukongtv.wkhelper.controller.b; class i { void a() { int a;
a=0;// .class final Lcom/wukongtv/wkhelper/controller/b/i;
...
a=0;//     .locals 0
a=0;// 
a=0;//     iput-object p1, p0, Lcom/wukongtv/wkhelper/controller/b/i;->c:Lcom/wukongtv/wkhelper/controller/b/g;
a=0;// 
a=0;//     iput p2, p0, Lcom/wukongtv/wkhelper/controller/b/i;->a:I
a=0;// 
a=0;//     iput p3, p0, Lcom/wukongtv/wkhelper/controller/b/i;->b:I
a=0;// 
a=0;//     invoke-direct {p0}, Ljava/lang/Object;-><init>()V
a=0;// 
a=0;//     #p0=(Reference,Lcom/wukongtv/wkhelper/controller/b/i;);
a=0;//     return-void
a=0;// .end method
a=0;// 
a=0;// 
...
a=0;// 
a=0;//     :try_start_0
a=0;//     iget-object v0, p0, Lcom/wukongtv/wkhelper/controller/b/i;->c:Lcom/wukongtv/wkhelper/controller/b/g;
a=0;// 
...
a=0;// 
a=0;//     #v3=(Null);
a=0;//     iget v4, p0, Lcom/wukongtv/wkhelper/controller/b/i;->a:I
a=0;// 
a=0;//     #v4=(Integer);
...
a=0;// 
a=0;//     #v3=(One);
a=0;//     iget v4, p0, Lcom/wukongtv/wkhelper/controller/b/i;->b:I
a=0;// 
a=0;//     #v4=(Integer);
a=0;//     invoke-static {v4}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;
a=0;// 
...
a=0;//     iget-object v0, p0, Lcom/wukongtv/wkhelper/controller/b/i;->c:Lcom/wukongtv/wkhelper/controller/b/g;
a=0;// 
a=0;//     iget-object v1, p0, Lcom/wukongtv/wkhelper/controller/b/i;->c:Lcom/wukongtv/wkhelper/controller/b/g;
a=0;// 
