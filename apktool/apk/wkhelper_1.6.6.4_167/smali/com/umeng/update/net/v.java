package com.umeng.update.net; class v { void a() { int a;
a=0;// .class public Lcom/umeng/update/net/v;
...
a=0;// 
a=0;// # instance fields
a=0;// .field final b:Landroid/content/Context;
a=0;// 
a=0;// 
a=0;// # direct methods
...
a=0;//     .locals 1
a=0;// 
a=0;//     const-class v0, Lcom/umeng/update/net/v;
a=0;// 
...
a=0;// 
a=0;//     sput-object v0, Lcom/umeng/update/net/v;->a:Ljava/lang/String;
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;// 
a=0;//     #p0=(Reference,Lcom/umeng/update/net/v;);
a=0;//     iput-object p1, p0, Lcom/umeng/update/net/v;->b:Landroid/content/Context;
a=0;// 
a=0;//     return-void
a=0;// .end method
a=0;// 
...
a=0;//     iget-object v0, p0, Lcom/umeng/update/net/v;->b:Landroid/content/Context;
a=0;// 
a=0;//     #v0=(Reference,Landroid/content/Context;);
a=0;//     const-string v2, "UMENG_RUNTIME_CACHE"
a=0;// 
...
a=0;// 
a=0;//     sget-object v4, Lcom/umeng/update/net/v;->a:Ljava/lang/String;
a=0;// 
a=0;//     new-instance v5, Ljava/lang/StringBuilder;
a=0;// 
a=0;//     #v5=(UninitRef,Ljava/lang/StringBuilder;);
a=0;//     const-string v6, "get nid ["
a=0;// 
...
a=0;//     move-result-object v0
a=0;// 
a=0;//     invoke-static {v4, v0}, La/b/b;->a(Ljava/lang/String;Ljava/lang/String;)V
a=0;//     :try_end_1
